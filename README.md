...
Fuzzy-finder for TI-BASIC commands
Automatic indenting for code blocks

### Requirements
**Running**  
&ensp;Terminal with Unicode and ANSI support  
**Building**  
&ensp;Go programming language
&ensp;Run ```go build ./...``` to get all dependencies and build
